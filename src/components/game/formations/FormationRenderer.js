...
export function FormationRenderer({ teamMode, selectedFormation, ...props }) {
  if (teamMode === TEAM_MODES.PAIRS_7) {
    ...
    return <IndividualFormation data-testid="formation-renderer" teamMode={teamMode} selectedFormation={selectedFormation} {...props} />;
  }
